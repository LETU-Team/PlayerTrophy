package lewismcreu.playertrophy.item;

import lewismcreu.playertrophy.util.Language;
...
public class ItemPlayerTrophy extends BaseItem
{
	...
	@Override
	public void addInformation(ItemStack stack, EntityPlayer player, List<String> list, boolean par)
	{
