...
public abstract class CommandClanBase extends PTCommandBase
{
	public CommandClanBase(String name)
	{
		super(name);
	}
	...
	public boolean checkPermission(MinecraftServer server, ICommandSender sender)
	{
		try
		{
			return super.checkPermission(server, sender) && getClan(sender)!=null && getClan(sender).hasRight(((EntityPlayer) sender)
					.getPersistentID(), getRequiredRight());
		}
